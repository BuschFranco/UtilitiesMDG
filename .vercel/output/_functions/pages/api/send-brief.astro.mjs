...
function formatBriefEmail(data, devId) {
  const trafficSources = Array.isArray(data.traffic_source) ? data.traffic_source.join(", ") : data.traffic_source || "No especificado";
  return `
<!DOCTYPE html>
<html>
<head>
...
<body>
    ...
    <div class="footer">
        <p>📅 Generado el: ${(/* @__PURE__ */ new Date()).toLocaleString("es-ES")}</p>
